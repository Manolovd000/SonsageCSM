...
taux_participation = (
    (df["Participation commission"] == "Oui").mean()*100
    if "Participation commission" in df.columns
    else 0
)


# Calcul des principales attentes de la commission
...
st.markdown("**Objectifs prioritaires de la commission**")
...
if "Type" in df.columns:
    ...
    if "Missions prioritaires" in df.columns:
        ...
        st.subheader("Missions prioritaires pour la commission")
